                ...
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 container m-auto">
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="phone" type="tel" placeholder="01780974765" name="Phone" ref={register({
                                required: true,
                                pattern: /(91)\d{9}/,
                            })} />
