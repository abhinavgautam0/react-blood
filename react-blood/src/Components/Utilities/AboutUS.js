        ...
        <section className="text-gray-700 body-font" id="About_Us">
            <div className="container mx-auto flex px-5 py-12 lg:flex-row flex-col items-center gap-3">
                <div
                    ...
                    <h1 className="text-5xl font-medium">Purpose</h1>
                    <hr className="border-red-600 border-2 w-16" />
                    <p className="tracking-wider text-left md:text-center">The aim of this website is to provide information to those who want blood in a critical time and to those who need blood.It is for public donation center with blood donation members in
